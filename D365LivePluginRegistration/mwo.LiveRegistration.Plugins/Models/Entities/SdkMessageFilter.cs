namespace mwo.LiveRegistration.Plugins.Models
{
	...
	public partial class SdkMessageFilter : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<mwo.LiveRegistration.Plugins.Models.SdkMessageProcessingStep> sdkmessagefilterid_sdkmessageprocessingstep
		{
			get
			{
				return this.GetRelatedEntities<mwo.LiveRegistration.Plugins.Models.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessagefilterid_sdkmessageprocessingstep");
				this.SetRelatedEntities<mwo.LiveRegistration.Plugins.Models.SdkMessageProcessingStep>("sdkmessagefilterid_sdkmessageprocessingstep", null, value);
		...
		public mwo.LiveRegistration.Plugins.Models.SdkMessage sdkmessageid_sdkmessagefilter
		{
			get
			{
				return this.GetRelatedEntity<mwo.LiveRegistration.Plugins.Models.SdkMessage>("sdkmessageid_sdkmessagefilter", null);
			}
			set
			{
				this.OnPropertyChanging("sdkmessageid_sdkmessagefilter");
				this.SetRelatedEntity<mwo.LiveRegistration.Plugins.Models.SdkMessage>("sdkmessageid_sdkmessagefilter", null, value);
